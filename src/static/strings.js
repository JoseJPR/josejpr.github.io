const strings = {
  seo:{
    ...
    language: 'ES',
    robots: 'index,follow',
    google_site_verification: 'BiOFAqtHNIdPnsrb3EKID5aBfvuachoUKyMgFIgzwqE',
    viewport: 'width=device-width, initial-scale=1, shrink-to-fit=no',
    title: 'JoseJPR | Developer & Software Architect',
    description: 'I´m Developer & Software Architect. Skills: JavaScript, NodeJS, ReactJS, QA Code, PWA Tech',
  ...
  global: {
    ...
    links: {
      ...
      project: 'https://github.com/JoseJPR/website-josejpr',
      phonegapspain: 'https://www.phonegapspain.com',
      github: 'https://github.com/JoseJPR',
